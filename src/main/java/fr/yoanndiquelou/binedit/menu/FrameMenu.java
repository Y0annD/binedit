...
public class FrameMenu extends JMenuBar {
	...
	public JMenu getEditMenu() {
		...
		JMenuItem copyBinaryItem = new JMenuItem(ActionManager.getInstance().getCopyBinaryAction());
	...
	public JMenu getDisplayMenu() {
		...
		JMenuItem fontItem = new JMenuItem(ActionManager.getInstance().getFontAction());
